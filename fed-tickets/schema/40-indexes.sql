...
create index group_members_by_member on group_members using hash (member_id);
create index group_tree on groups using gist (admin_path);
create index group_tree_eq on groups using hash (admin_path);
