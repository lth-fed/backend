...
create table "public"."transaction_reserved_ids" (
    "id" uuid not null,
...
CREATE UNIQUE INDEX transaction_reserved_ids_pkey ON public.transaction_reserved_ids USING btree (id);
...
alter table "public"."transaction_reserved_ids" add constraint "transaction_reserved_ids_pkey" PRIMARY KEY using index "transaction_reserved_ids_pkey";
...
alter table "public"."transaction_wares" add constraint "transaction_wares_transaction_id_fkey" FOREIGN KEY ("transaction_id") REFERENCES "public"."transactions"("id") ON DELETE CASCADE NOT VALID;
