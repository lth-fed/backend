...
alter table "public"."group_adminships" add constraint "group_adminships_group_membership_fk" FOREIGN KEY ("user_id", "group_id") REFERENCES "public"."group_memberships"("user_id", "group_id") NOT VALID;
