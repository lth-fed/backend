...
<!-- $ openssl req -x509 -newkey rsa:4096 -keyout /tmp/pk.pem -out /tmp/cert.pem -days 7300 -nodes -subj "/C=SE/ST=Sverige/L=Lund/O=Maintainers of Teknologappen/CN=api.auth.teknologappen.se" 2>/dev/null-->
